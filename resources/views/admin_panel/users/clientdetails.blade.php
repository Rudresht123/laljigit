...
<div class="card-header b-0 rounded-0 pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex">
        <a href="{{route('admin.attorney.edit-clientDetails',['attoerny_id'=>$clientdetail->attorney_id,'category_slug'=>$clientdetail->mainCategory->category_slug,'application_no'=>$clientdetail->application_no])}}" class="btn btn-xs rounded-5 btn-outline-success d-flex align-items-center mg-r-5"><i class="typcn typcn-edit"></i> <span class="d-none d-sm-inline mg-l-5"> Edit</span></a>
        <a target="_blank" href="{{route('admin.client-details.print-pdf',['category_slug'=>$clientdetail->mainCategory->category_slug,'application_no'=>$clientdetail->application_no])}}" class="btn btn-xs rounded-5 btn-outline-primary d-flex align-items-center mg-r-5"><i class="typcn typcn-printer"></i>  Print</button>
                    ...
                    <div class="tab-pane fade active show" id="home5" role="tabpanel" aria-labelledby="home-tab5">
                        <div data-label="Office Details" class="df-example">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Opponenet Applicant Name</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->opponenet_applicant_name ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Opposition Hearing Date</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->opposition_hearing_date ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Valid Up To</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->valid_up_to ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Status</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->statusMain->status_name ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Status Remarks</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{ $clientdetail->subStatus->substatus_name ?? null }}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Consultant Name</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->Clientonsultant->consultant_name ?? ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Deal With</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->deal_with ? $clientdetail->dealWith->dealler_name : ''}}</div></div></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Office</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->office->office_name ? $clientdetail->office->office_name : ''}}</div></div></div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Client_remarks</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->clientRemark->client_remarks ?? ''}}</div></div></div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Evidence Last Date</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->evidence_last_date ?? ''}}</div></div></div>
                                </div>


                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Email Recived Date</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->	mail_recived_date ?? ''}}</div></div></div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="row mb-2"><div class=" pt-2 col-4"><b>Email Recived Date 2</b></div><div class="col-8"><div class="bg-light ht-35 p-2">{{$clientdetail->mail_recived_date_2 ??''}}</div></div></div>
                                </div>


                                <div class="col-lg-12">
                                    <div class="row mb-2"><div class=" pt-2 col-2"><b>Email Remarks</b></div><div class="col-10"><div class="bg-light ht-35 p-2">{{$clientdetail->email_remarks ?? ''}}</div></div></div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="row mb-2"><div class=" pt-2 col-2"><b>Client Communication</b></div><div class="col-10"><div class="bg-light ht-35 p-2">{{$clientdetail->client_communication ?? ''}}</div></div></div>
                                </div>

                                <div class="col-lg-12">
                                    <div class="row mb-2"><div class=" pt-2 col-2"><b>Remarks</b></div><div class="col-10"><div class="bg-light ht-35 p-2">{{$clientdetail->remarksMain->remarks_name ?? ''}}</div></div></div>
                                </div>
