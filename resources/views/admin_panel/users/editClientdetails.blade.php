...
@section('main-content')
            ...
            <div class="panel-body pd-b-0 row">
                <div class="col-lg-12 vhr p-3">
                    ...
                    @if ($category->category_slug === 'trademark')
                        <form id="registrationTrademarkForm" action="{{ route('admin.attorney.updatetrademarkformdata',$client->application_no) }}"
                            method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select name="office_id" class="form-select" required id="office_id">
                                            ...
                                            @foreach ($offices as $office)
                                                <option value="{{ $office->id ? $office->id : '' }}" {{$office->id==$client->office_id ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Application No.<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->application_no ? $client->application_no : ''}}" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Firm Name<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->file_name ? $client->file_name : ''}}" class="form-control" required
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Trademark Name<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->trademark_name ? $client->trademark_name : ''}}" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select name="trademark_class" required class="form-select" id="trademarkclass">
                                            ...
                                            @foreach ($classes as $class)
                                                <option value="{{ $class->class_name ? $class->class_name : '' }}" {{$class->class_name==$client->trademark_class ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Filling Date<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->filling_date ? $client->filling_date : ''}}"
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Phone Number<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->phone_no ? $client->phone_no : ''}}" class="form-control" required
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Email ID<span
                                                class="text-danger">*</span></label>
                                        <input type="email" value="{{$client->email_id ? $client->email_id : ''}}" class="form-control"
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Objected Hearing Date<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->objected_hearing_date ? $client->objected_hearing_date : ''}}"
                                    ...
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">Opposition Hearing Date<span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->opposition_hearing_date ? $client->opposition_hearing_date : ''}}"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" value="{{$client->valid_up_to ? $client->valid_up_to : ''}}"
                                        ...
                                        <select name="status" id="status" required class="form-select"
                                            ...
                                            @foreach ($statuss as $status)
                                                <option data-slug="{{ $status->slug ?? '' }}"
                                                    data-id="{{ $status->id }}"
                                                    value="{{ $status->id ? $status->id : '' }}" {{$status->id == $client->status ? 'selected' : ''}}>
                                    ...
                                    <div class="col-sm-4" id="rectification_no" style="display: none;">
                                        ...
                                        <input type="text" value="{{$client->rectification_no ?? ''}}" class="form-control"
                                    ...
                                    <div class="col-sm-4" id="opponent_applicant" style="display: none;">
                                        ...
                                        <select id="opp_app_name" name="opponent_applicant" class="form-select">
                                            ...
                                            <option value="Opponent" {{$client->opponent_applicant=='Opponent' ? 'selected' : ''}}>Opponent</option>
                                            <option value="Applicant" {{$client->opponent_applicant=='Applicant' ? 'selected' : ''}}>Applicant</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-4" id="applicant_name" style="display: none;">
                                        ...
                                        <input type="text" value="{{$client->opponent_applicant=='Opponent' ? $client->opponenet_applicant_name : ''}}" class="form-control" name="applicant_name"
                                    ...
                                    <div class="col-sm-4" id="applicant_code" style="display: none;">
                                        ...
                                        <input type="text" value="{{$client->opponent_applicant=='Opponent' ? $client->opponent_applicant_code : ''}}" class="form-control" name="applicant_code"
                                    ...
                                    <div class="col-sm-4" id="opponent_name" style="display: none;">
                                        ...
                                        <input type="text" value="{{$client->opponent_applicant=='Applicant' ? $client->opponenet_applicant_name : ''}}" class="form-control" name="opponent_name"
                                    ...
                                    <div class="col-sm-4" id="opponent_code" style="display: none;">
                                        ...
                                        <input type="text" value="{{$client->opponent_applicant=='Applicant' ? $client->opponent_applicant_code : ''}}" class="form-control" name="opponent_code"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select name="sub_category" id="sub-category" required
                                            ...
                                            @foreach ($subcategory as $subcat)
                                                <option value="{{ $subcat->id ? $subcat->id : '' }}" {{$subcat->id == $client->sub_category ? 'selected' :''}}>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <select name="consultant" required class="form-select" id="consultant">
                                            ...
                                            @foreach ($consultant as $consultant)
                                                <option value="{{ $consultant->id ?? '' }}" {{$consultant->id == $client->consultant ? 'selected' :''}}>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select name="deal_with" required class="form-select" id="deal_with">
                                            ...
                                            @foreach ($dealWith as $dealw)
                                                <option value="{{ $dealw->id ?? '' }}" {{$dealw->id == $client->deal_with ? 'selected' :''}}>{{ $dealw->dealler_name ?? '' }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" class="form-control" readonly required
                                            value="{{ $client->filed_by ? $client->filed_by : '' }}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="remarks" required class="form-select select2" id="remarks">
                                            ...
                                            @foreach ($remarks as $remark)
                                                <option value="{{ $remark->id ? $remark->id : '' }}" {{$remark->id==$client->remarks ? 'selected' :'' }}>
                                    ...
                                    <div class="col-sm-6 ">
                                        ...
                                        <select name="client_remarks" required class="form-control select2 "
                                            ...
                                            @foreach ($clientRemarks as $cleintRemark)
                                                <option value="{{ $cleintRemark->id ? $cleintRemark->id : '' }}" {{$cleintRemark->id==$client->client_remarks ? 'selected' :'' }} >
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="" class="form-label">IP Field <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{$client->ip_field ?? ''}}" name="ip_field"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" name="evidence_last_date"
                                            value="{{$client->evidence_last_date ?? ''}}" class="form-control datepicker"
    ...
    const statusId = $('#status').find(':selected').val();
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#status').on('change', function (e) {
                e.preventDefault();
                const statusSlug = $(this).find(':selected').data('slug'); // Fetch the data-slug of selected option
                if (statusSlug) {
            ...
            $('#opp_app_name').on('change', function (e) {
                ...
                if (getvalue && statusSlug) {
                    getOpponentApplicantNameNumber(getvalue, statusSlug); // Call function with value and slug
                }
            });
