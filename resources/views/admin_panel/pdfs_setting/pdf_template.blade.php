                    ...
                    <div class="row mb-3 d-flex justify-content-end">
                        <div class="col-sm-12">
                            <div class="panel-heading">
                                <b><i class="fa fa-list"></i> Create PDF Template</b>
                                <a href="{{route('admin.global-setting.pdf-template')}}" class="btn btn-primary float-end">All Template</a>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('admin.global-setting.create-pdf-template') }}" method="POST">
                        @csrf
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="template_slug" required class="form-control" placeholder="Enter Template Slug.." required>
                                    </div>
                                </div>
                                
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="" class="form-label">Template Logo<span class="text-danger">*</span></label>
                                        <input type="file" name="template_logo" required class="form-control" placeholder="Enter Template Slug.." required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="" class="form-label">Template Watermark</label>
                                        <input type="file" name="template_watermark" class="form-control" placeholder="Enter Template Slug.." required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" class="form-control" id="editor" cols="30" rows="10" style="display:none;"></textarea>
