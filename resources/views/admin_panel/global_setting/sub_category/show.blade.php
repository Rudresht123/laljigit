    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
            ...
            <li class="breadcrumb-item " aria-current="page"><a
                    href="{{ route('admin.global-setting.main-category') }}">Main-Category</a></li>
            ...
            <div class="panel-body p-1 p-md-3 pd-b-0"> <!-- Flexbox for lg and md screens, stack on small screens -->
                <div class="row d-flex flex-lg-row flex-md-row flex-sm-column">
                    <div class="col-lg-6 mx-auto col-md-3 mb-3">
                        ...
                        <select name="main_category_id" id="main_category_id" class="form-select" id="">
                    ...
                    <div class="col-sm-4 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Search Input..." onkeyup="filterTableData('subCategoryTable',this.value)">
                    </div>
                </div>
                    ...
                    <table id="subCategoryTable" class="table table-bordered">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th class="border fw-bold">Sub-Category Name</th>
                                <th class="border fw-bold">Remark</th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#main_category_id').change(function(e) {
                    ...
                    let route = "{{ route('admin.global-setting.show.sub-category', ':id') }}".replace(':id',
                        mainCategoryId);
                        ...
                        success: function(response) {
                            ...
                            if (response.data && response.data.length > 0) {
                                response.data.forEach(subcat => {
                                    let statusText = subcat.status === 'yes' ?
                                    ...
                                    let row = `
                                        <tr>
                                            ...
                                            <td class="border">${subcat.subcategory}</td>
                                            <td class="border">${subcat.subcategory_remark}</td>
                                            <td class="border">${statusText}</td>
                                            <td class="d-flex border justify-content-center">
                                              <a href="{{ route('admin.global-setting.edit.sub-category', '') }}/${subcat.id}" class="editButton text-primary p-1 rounded fw-bold" data-id="${subcat.id}">
    <i class="far fa-edit"></i>
</a>

                                                <a href="" class="deleteButton text-danger p-1 rounded fw-bold" data-id="${subcat.id}">
            ...
            $('#subCategoryTable').on('click', '.deleteButton', function(e) { // Corrected this line
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let route = "{{ route('admin.global-setting.delete.sub-category', ':id') }}".replace(':id', subCategoryId);
