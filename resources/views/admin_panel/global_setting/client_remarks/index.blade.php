...
@section('main-content')
                ...
                <div class="modal-body">
                    ...
                    <form id="addNewRemarks" method="POST">
                       ...
                       <div class="row mt-3">
                        ...
                        <button type="button" class="btn btn-secondary me-1 px-2 p-1" data-bs-dismiss="modal">Close</button>
    ...
    <script class="text/javascript">
        $(document).ready(function() {
            ...
            $('#addNewRemarks').on('submit', function(e) {
                ...
                $('#ld').show();
                $('#overlay').show();
                let route = "{{ route('admin.global-setting.create-client-remarks') }}";
            ...
            $('#ClientremarksTable').on('click','.editButton', function(e) {
                e.preventDefault();
                let remarksId = $(this).data('id');
                let route = "{{ route('admin.global-setting.edit-client-remarks', ':id') }}".replace(':id',
                    remarksId);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('textarea[name="client_remarks"]').val(response.client_remarks);
 ...
 // Set checkbox status
            ...
            $('#editRemarks').on('submit', function(e) {
                ...
                let route = "{{ route('admin.global-setting.update-client-remarks', ':id') }}".replace(':id',
                    remarkId);
                let formData = $(this).serialize();
            ...
            $('#ClientremarksTable').on('click','.deletebutton', function(e) {
                e.preventDefault();
                Swal.fire({
                    title: 'Are you sure?',
