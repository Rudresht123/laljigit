            ...
            <div class="panel-body pd-b-0 row">
                <div class="col-lg-2 mb-3">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#addModal"
                        ...
                        <i class="fa fa-plus"></i> Add New Consultant
                    </button>
                </div>

                <div class="col-lg-10 vhr">
                    <div class="table-responsive">
                        <table id="consultantTable" class="table table-hover fs-10">
    ...
    <script class="text/javascript">
        $(document).ready(function() {
            ...
            $('#addStatus').on('submit', function(e) {
                ...
                $('#ld').show();
                $('#overlay').show();
                let route = "{{ route('admin.global-setting.create-consultant') }}";
            ...
            $('#consultantTable').on('click', '.editButton', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('input[name="consultant_name"]').val(response.consultant_name);
